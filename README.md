# Spring - Restful WS
## Preface
This is example of Spring MVC - Restful-WS integration. Tutorial can be found at 

https://springtutor.wordpress.com/2015/09/01/retreiving-data-from-web-services/
...
Finally, to run the example, right click on the project and choose Run as - Maven build. As a goal type tomcat7:run. First time Spring STS will download tomcat7 web server and at the end run the app. To try application, in favorite web browser type http://localhost:8080/SpringTutor002. 
